...
class Arguments:
	...
	dataset_path = get_path("/root/sim/VoiceConversion/Datasets/VCTK", dataset_name)
	model_name = "CVQ"
	...
	formatted_dir = get_path(dataset_path, "formatted")
	# wav_dir = get_path(dataset_path)
	...
	max_wav_value = 1		# for other dataset
	...
	conversion_visible_devices = "0"

	train_batch_size = 120
	eval_batch_size = 100 
	eval_step = 1000
	eval_path = "/root/sim/VoiceConversion/DL_Projects/eval_results/"+model_name
	...
	vocoder_pretrained_model_path = get_path("/root/sim/VoiceConversion/DL_Projects/vocoder", "{}", vocoder_pretrained_model_name).format(vocoder)
	# print('i')
