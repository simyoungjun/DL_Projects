...
from data import vctk, vctk_hpss
...
def prepro_wavs():
	...
	harmonic_path = create_dir(args.prepro_harmonic_dir)
	percussive_path = create_dir(args.prepro_percussive_dir)
